...
public class FileInfoService extends ServiceImpl<FileInfoMapper, FileInfo> {
     ...
     * 上传图片
     */
    public UploadResult uploadFileByBigScreen(MultipartFile file) {
        ...
        uploadResult.setFileSavePath("/paths/" + finalName);

        try {
            //保存文件到指定目录
            System.out.println(fileRootPath);
            System.out.println(finalName);
            File newFile = new File(fileRootPath + finalName);
            ...
            fileInfo.setFilePath("/paths/" + finalName);
